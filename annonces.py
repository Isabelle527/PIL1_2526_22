...
# On passe maintenant une fonction (get_db_connection) au lieu d'un objet mysql
def init_routes_annonces(app, get_db_connection):
    ...
    def modifier_profil_complet():
        ...
        # Ouverture de la connexion avec mysql-connector
        ...
        conn.commit()
        cursor.close()
        conn.close() # Fermeture importante avec mysql-connector
